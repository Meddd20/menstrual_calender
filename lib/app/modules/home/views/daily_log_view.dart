                    ...
                    children: [
                      CustomCalendar(
                        ...
                        dayBuilder: (BuildContext context, DateTime day) {
                          ...
                          for (int i = 0;
                              ...
                              i++) {
                            DateTime haidAwal = homeController.haidAwalList[i];
                            DateTime haidAkhir =
                          ...
                          for (int j = 0;
                              ...
                              j++) {
                            DateTime ovulasi = homeController.ovulasiList[j];
                          ...
                          for (int i = 0;
                              i < homeController.predictHaidAwalList.length;
                              i++) {
                            DateTime predictHaidAwal =
                                homeController.predictHaidAwalList[i];
                            DateTime predictHaidAkhir =
                                homeController.predictHaidAkhirList[i];
                          ...
                          for (int j = 0;
                              j < homeController.predictOvulasiList.length;
                              j++) {
                            DateTime predictOvulasi =
                                homeController.predictOvulasiList[j];
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          Obx(
                            () => Container(
                              height: controller.isChanged.value ? 60.h : 8.h,
                            ),
                          ),
                        ],
                      ),
