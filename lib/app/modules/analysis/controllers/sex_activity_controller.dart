...
class SexActivityController extends GetxController {
  final ApiService apiService = ApiService();
  late final LogRepository logRepository = LogRepository(apiService);
  late Data data;
  RxMap<String, dynamic> sexActivity = RxMap<String, dynamic>();
  ...
  void onInit() {
    ...
    sexActivity = RxMap<String, dynamic>();
  ...
  Map<String, dynamic> specifiedDataByDate() {
    ...
    specificSexActivityData.clear();

    List<MapEntry<String, dynamic>> filteredData =
        sexActivity.entries.where((entry) {
    ...
    for (var entry in filteredData) {
      specificSexActivityData[entry.key] = entry.value;
    }

    return specificSexActivityData;
  }

  Future<void> fetchOthers() async {
    try {
      DailyLogTags? result = await logRepository.getLogsByTags("sex_activity");
