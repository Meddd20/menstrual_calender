...
class SymptomsView extends GetView<SymptomsController> {
          ...
          return Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  "${controller.specificSymptomsData.length} Entries",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 30,
                ...
                Expanded(
                  child: Container(
                    height: Get.height,
                    child: Obx(() {
                      if (controller.specificSymptomsData.isEmpty) {
                        return Center(child: Text("No data available"));
                      } else {
                        return ListView.builder(
                          itemCount: controller.specificSymptomsData.length,
                          itemBuilder: (context, index) {
                            final MapEntry<String, dynamic> entry = controller
                                .specificSymptomsData.entries
                                .elementAt(index);
